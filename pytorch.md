...
https://qiita.com/sennbei/items/598365cf3b68955e11c5
...
import glob, random
#描写する画像があるディレクトリ
imgdpath= '/mnt/data0/share/POLA/data/POLA.190420/17女性0w腕/17女性0w腕/17女性腕_角層_高倍率'
#画像パスをリストとして取得
imgpaths = glob.glob(imgdpath+'/*')
#画像パスをランダムにn個取得
n_imgpaths = random.sample(imgpaths,4)
